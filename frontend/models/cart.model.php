...
class CartModel{
	...
	public static function newPurchases($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table (id_user, id_product, meeting_url, method, email, address, country, payment, date_initial, time_zone) VALUES (:id_user, :id_product, :meeting_url, :method, :email, :address, :country, :payment, :date_initial, :time_zone)");
