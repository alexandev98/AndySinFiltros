...
class ModelProducts{
	...
	public static function editProduct($tabla, $datos){
		...
		$stmt = Connection::connect()->prepare("UPDATE $tabla SET route = :route, state = :state, title = :title, titular = :titular, description = :description, hour = :hour, details = :details, price = :price, front = :front, offer = :offer, offerPrice = :offerPrice, discountOffer = :discountOffer WHERE id = :id");
